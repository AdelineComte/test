...
args="C:/Users/Cimcä/Desktop/chiro/Fichiers_base/SpNuit2_Seuil90_DataLP_PF_exportTot"
...
args[2]="GI_SysGrid__75_100"
args[3]="C:/Users/Cimcä/Desktop/chiro/Fichiers_base/SpeciesList.csv"
#args[3]=NA
...
#recup gridSIG
Sys.time()
CoordSIG=fread(paste0("C:/Users/Cimcä/Desktop/Chiro/Fichiers_obtenus/",args[2],".csv"))
Sys.time()
...
for (i in 1:length(ListSp))
{
  ...
  fwrite(DataSpSL,paste0("C:/Users/Cimcä/Desktop/Chiro/Fichiers_obtenus/DataSpSL_",ListSp[i],".csv"))
  ...
  if(sum(DataSaison$nb_contacts)>=MinData)
  {
    ...
    save (ModRF,file=paste0("C:/Users/Cimcä/Desktop/Chiro/Fichiers_obtenus/ModRFActLog_",ListSp[i]
    ...
    if(Bat)
    {
      ...
      save (ModRF_DM,file=paste0("C:/Users/Cimcä/Desktop/Chiro/Fichiers_obtenus/ModRFDecMin_",ListSp[i]
                                 ,substr(args[1],nchar(args[1])-7,nchar(args[1]))
                                 ,".learner")) 
