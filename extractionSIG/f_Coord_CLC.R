#Consideration of land use patterns  (Medium and large buffers)
...
if(Test)
{
  ...
  Coord_CLC(
    ...
    ,bm=500
    ,bl=5000
    ,layer="C:/Users/Cimcä/Desktop/Chiro/Fichiers SIG/CLC12_FR_RGF_SHP/CLC12_FR_RGF_SHP/CLC12_FR_RGF.shp"
  )
}